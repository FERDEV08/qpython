...
def validaTraslape  (capa1,capa2):
        ...
        if (bandpoligono):
          ...
          ds = driver.CreateDataSource("C:/Users/pc-1/Downloads/Insumos/Insumos/Shapes/traslape.shp")
          ...
          print (" ")     
          capaRes = QgsVectorLayer("C:/Users/pc-1/Downloads/Insumos/Insumos/Shapes/traslape.shp","capaTraslape","ogr")
          QgsProject.instance().addMapLayer(capaRes)
pass

print ('Validacion de Traslape')
capa1 = 'C:/Users/pc-1/Downloads/Insumos/Insumos/Shapes/01001m/01001m.shp'
